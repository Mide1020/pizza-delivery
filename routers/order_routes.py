...
async def hello(Authorize: AuthJWT = Depends()):
    ...
    """
        ## A sample of hello world route
        it returns Hello order
    """
    try:
...
async def list_all_orders(Authorize: AuthJWT = Depends()):
    """
        ## Get all orders
        This Gets all  orders. and can be accessed by only super users
...
async def get_order_by_id(id:int,Authorize:AuthJWT=Depends()):
    """
        ## Gets an orderonly  by  ID
        This gets an order by its ID and is also  accessed by a superuser
...
async def get_user_orders(Authorize:AuthJWT=Depends()):
    """
        ...
        This gets the orders of the current user
